...
function MRT_rest_get_settings_handler( WP_REST_Request $request ) {
	...
	return rest_ensure_response(
		array(
			...
			'wizard_beta_enabled'                => ! empty( $opts['wizard_beta_enabled'] ),
			'wizard_feedback_enabled'            => ! empty( $opts['wizard_feedback_enabled'] ),
...
function MRT_rest_save_settings_handler( WP_REST_Request $request ) {
	...
	$saved  = MRT_sanitize_plugin_settings(
		array(
			...
			'wizard_beta_enabled'              => ! empty( $body['wizard_beta_enabled'] ) ? '1' : '',
			'wizard_feedback_enabled'          => ! empty( $body['wizard_feedback_enabled'] ) ? '1' : '',
