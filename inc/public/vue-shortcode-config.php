...
function MRT_vue_wizard_config( array $stations, array $parsed ): array {
	...
	return array(
		...
		'labels'       => array(
			...
			'feedbackClose'        => __( 'Stäng', 'museum-railway-timetable' ),
			'feedbackMessage'          => __( 'Beskrivning', 'museum-railway-timetable' ),
			'feedbackMessageHint'      => __( 'Minst 10 tecken.', 'museum-railway-timetable' ),
			'feedbackMessageTooShort'  => __( 'Minst 10 tecken krävs.', 'museum-railway-timetable' ),
...
function MRT_vue_traffic_notices_config( array $context ): array {
	...
	return array(
		...
		'labels'        => array(
			...
			'sectionOngoing'  => __( 'Aktuellt trafikläge', 'museum-railway-timetable' ),
			'sectionUpcoming' => __( 'Planerade avvikelser', 'museum-railway-timetable' ),
