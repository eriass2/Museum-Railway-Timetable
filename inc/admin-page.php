        ...
        <div class="mrt-guide-section">
            ...
            <div class="mrt-guide-content">
                ...
                <ol>
                    ...
                    <li><strong><?php esc_html_e('Configure Stop Times', 'museum-railway-timetable'); ?></strong> - <?php esc_html_e('Click "Edit" on any trip to set arrival/departure times for each station', 'museum-railway-timetable'); ?></li>
                </ol>
                <p class="mrt-tip-box">
