...
function MRT_register_station_post_type(): void {
    register_post_type(MRT_POST_TYPE_STATION, [
        'labels' => [
...
function MRT_register_route_post_type(): void {
    register_post_type(MRT_POST_TYPE_ROUTE, [
        'labels' => [
...
function MRT_register_service_post_type(): void {
    register_post_type(MRT_POST_TYPE_SERVICE, [
        'labels' => [
...
function MRT_register_train_type_taxonomy(): void {
    register_taxonomy(MRT_TAXONOMY_TRAIN_TYPE, MRT_POST_TYPE_SERVICE, [
        'labels' => [
