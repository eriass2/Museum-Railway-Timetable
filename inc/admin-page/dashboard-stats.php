...
function MRT_render_dashboard_stats($stats) {
    ...
    <div class="mrt-grid mrt-grid-auto mrt-dashboard-stats">
        <div class="mrt-card mrt-stat-card">
            <div class="mrt-stat-number"><?php echo esc_html($stats['stations_count']); ?></div>
        ...
        <div class="mrt-card mrt-stat-card">
            <div class="mrt-stat-number"><?php echo esc_html($stats['timetables_count']); ?></div>
            <div class="mrt-stat-label">
        ...
        <div class="mrt-card mrt-stat-card">
            <div class="mrt-stat-number"><?php echo esc_html($stats['services_count']); ?></div>
            <div class="mrt-stat-label">
        ...
        <div class="mrt-card mrt-stat-card">
            <div class="mrt-stat-number"><?php echo esc_html($stats['train_types_count']); ?></div>
            <div class="mrt-stat-label">
