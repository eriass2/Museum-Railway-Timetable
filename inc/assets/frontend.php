...
function MRT_journey_wizard_l10n_steps_and_trip(): array {
	return array(
		...
		'stepDate'         => __( 'Välj datum', MRT_TEXT_DOMAIN ),
		'stepOutbound'     => __( 'Välj utresa', MRT_TEXT_DOMAIN ),
		'stepReturn'       => __( 'Välj återresa', MRT_TEXT_DOMAIN ),
		'stepSummary'      => __( 'Din resa', MRT_TEXT_DOMAIN ),
		...
		'defaultTrainType' => __( 'Tåg', MRT_TEXT_DOMAIN ),
