...
function MRT_admin_vue_l10n_stations(): array {
	return array(
		...
		'stationsEmptyStationsMsg'   => __( 'Skapa en station med knappen nedan.', 'museum-railway-timetable' ),
		'stationsEditStationTitle'   => __( 'Redigera station: %s', 'museum-railway-timetable' ),
