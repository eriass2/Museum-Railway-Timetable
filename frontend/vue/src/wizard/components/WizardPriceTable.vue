<template>
  <div
    v-if="priceData"
    class="mrt-journey-wizard__prices mrt-mt-lg"
    :class="{ 'mrt-journey-wizard__prices--card': compactTitle }"
  >
      ...
      <table class="mrt-table mrt-journey-wizard__price-table">
        ...
        <tbody>
          <tr
            ...
            :key="tk"
            :class="{ 'mrt-journey-wizard__price-row--active': tk === priceData.activeType }"
          >
    ...
    <p v-if="cfgStr(cfg, 'priceNote', '')" class="mrt-text-secondary mrt-journey-wizard__price-note mrt-mt-sm">
