...
- [x] **Fas 3:** Shortcode `horizon_days` docs, ev. dedikerad sida
- [x] **Fas 4:** Admin — förhandsvisning av samma feed
...
- [x] Dev-reset + omimport (2026-06-11, linjer Fas D)
- [x] **Verifiering tur 71** GRÖN 2026-06-06 (Uppsala→Faringe): Uppsala Ö `10.00`, Barby `10.23`, Skölsta `Ca 10.09 X`, Marielund `10.35`
...
- [x] E2E/admin: redigering efter Marielund sparar rätt `serviceId` (2026-06-11)
- [x] **Manuell check:** GRÖN 2026-06-06 Faringe→Uppsala — 5 kolumner (70, 60, 62, 96, 78); Marielund ankomst/avgång i samma kolumn (2026-06-11)
- [x] Tur 71 ut utan kolumn 61 i Faringe→Uppsala-vy (2026-06-11)
...
- [x] **Manuell check GRÖN:** Selkné buss vid knutpunkt — stämmer mot `Anslagstidtabell-2026.pdf` (2026-06-11)
- [x] **Manuell check GRÖN:** buss tur 71/63 vid Selkné (2026-06-11)
- [x] **Manuell check RÖD:** Marielund Linnés + Selkné utan Linnés (2026-06-11)
- [x] **Manuell check RÖD:** Faringe→Uppsala 2026-07-05 — Marielund tur 94 radordning (tåg före buss) + B12 (2026-06-11)
...
- [x] **Manuell check admin Linjer** (A1–A5): Stationer & linjer, 4 linjer, redigera titel (2026-06-11)
...
- [x] **Manuell smoke:** Uppsala Östra → Fjällnora (3 ben) — byte Marielund ≈ 10 min, byte Selkné ≈ 3 min (2026-06-11)
- [x] **Manuell smoke:** Linnés → Uppsala direkt (B14) (2026-06-11)
...
- [x] Verifiera reseplanerare + Turvy för Linnés Hammarby (B9–B14, fixture) (2026-06-11)
