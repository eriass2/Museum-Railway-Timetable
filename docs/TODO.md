...
| TF-C5 | Återanvänd `MrtInfoMark` i info-count-badge | Frontend | öppen |
...
| ID | Punkt | Ansvar | Status |
|----|-------|--------|--------|
| TF-H1 | Enqueue `mrt-traffic-info-tokens.css` för shortcode/noscript (`frontend.php` / shortcode) | Backend | öppen |
| TF-H2 | Verifiera `alignwide` + `MrtPublicAppShell` på Lennakatten-tema (test3) | Test + Produkt | öppen |
