...
| TF-F4 | Playwright screenshots desktop + mobil (`traffic-notices-ul-*.png`) | Test | öppen — spec `traffic-notices-ul-layout.spec.ts`, snapshots kräver linux CI/`playwright install` |
