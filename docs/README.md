...
| [PUBLIC_JOURNEY_IMPLEMENTATION_PLAN.md](PUBLIC_JOURNEY_IMPLEMENTATION_PLAN.md) | Publikt reseflöde (Del 1–2 + wizard + planner **MVP slutförd**; valfritt nästa steg i dokumentet) |
