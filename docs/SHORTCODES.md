...
- `ticket_url` – Biljett-URL (valfritt). Överstyr global URL från Inställningar. Visar knappen «Mer information om biljettköp» i sammanfattningen (länk till infosida, inte onlinebokning)
