...
python scripts/verify-lennakatten-b-pdf.py
...
|----------|--------|-------|
| Stopptider GRÖN/GUL räls | `scripts/lennakatten_b_pdf.py` | **Tidtabellsboken-del-B.pdf** |
| Stopptider GRÖN-buss | `scripts/lennakatten_anslag_tables.py` | Anslag |
| Stopptider RÖD/ORANGE | `scripts/lennakatten_anslag_tables.py` | Anslag (tider) + symboler |
| P/X-symboler / modes (buss, RÖD/ORANGE) | `scripts/lennakatten_symbols.py` | Anslag |
| Bussfönster och `green-buss`-datum | `scripts/lennakatten_calendar.py` | Anslag |
| Verifiering mot B | `scripts/verify-lennakatten-b-pdf.py` | Tur **71** m.fl. |
