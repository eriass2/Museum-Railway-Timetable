...
python scripts/fixtures/lennakatten/verify-lennakatten-b-pdf.py
...
| Innehåll | Modul | Källa |
|----------|--------|-------|
| Stopptider GRÖN/GUL räls | `scripts/fixtures/lennakatten/lennakatten_b_pdf.py` | **Tidtabellsboken-del-B.pdf** |
| Stopptider GRÖN-buss | `scripts/fixtures/lennakatten/lennakatten_anslag_tables.py` | Anslag |
| Stopptider RÖD/ORANGE | `scripts/fixtures/lennakatten/lennakatten_anslag_tables.py` | Anslag (tider) + symboler |
| P/X-symboler / modes (buss, RÖD/ORANGE) | `scripts/fixtures/lennakatten/lennakatten_symbols.py` | Anslag |
| Bussfönster och `green-buss`-datum | `scripts/fixtures/lennakatten/lennakatten_calendar.py` | Anslag |
| Verifiering mot B | `scripts/fixtures/lennakatten/verify-lennakatten-b-pdf.py` | Tur **71** m.fl. |
